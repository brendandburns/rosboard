class WebSocketV1Transport {
    constructor({path, onOpen, onClose, onRosMsg, onTopics, onActions, onSystem}) {
      this.path = path;
      ...
      this.onActions = onActions ? onActions.bind(this) : null;
    ...
    connect() {
      ...
      this.ws.onmessage = function(wsmsg) {
        ...
        else if(wsMsgType === WebSocketV1Transport.MSG_ACTIONS && that.onActions) that.onActions(data[1]);
  ...
  WebSocketV1Transport.MSG_ACTIONS = "a";
